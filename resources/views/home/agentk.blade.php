...
@section('title','Agent Kardelen Keleş')
            ...
            <div class="row">
                <div class="col-md-12 col-lg-8">
                    <div class="title-single-box">
                        <h1 class="title-single">Kardelen Keleş</h1>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="agent-avatar-box">
                                <img src="{{asset('assets')}}/img/k1.jpg" alt="" class="agent-avatar img-fluid">
                            </div>
                        </div>
                            ...
                            <div class="agent-info-box">
                                ...
                                <div class="agent-content mb-3">
                                    ...
                                    <div class="info-agents color-a">
                                        ...
                                        <p>
                                            <strong>Email: </strong>
                                            <span class="color-text-a"> kardo-ak-47@hotmail.com</span>
                                        </p>
                                        <p>
                                            <strong>skype: </strong>
                                            <span class="color-text-a"> Kardelen.Es</span>
                                        </p>
                                    </div>
                                </div>
